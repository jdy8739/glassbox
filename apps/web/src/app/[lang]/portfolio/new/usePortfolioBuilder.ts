...
import type { PortfolioItem as SearchResultItem } from '@glassbox/types';
...
export function usePortfolioBuilder() {
  ...
  const searchQuery = useQuery({
    ...
    queryFn: () => searchTickers(debouncedSearchInput),
  ...
  const loadTemplate = (templateItems: PortfolioItem[]) => {
