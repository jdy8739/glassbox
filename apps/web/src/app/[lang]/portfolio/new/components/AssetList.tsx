        ...
        return (
          ...
          >
            ...
            <div className="relative p-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
              {/* Top Row: Symbol + Info + Remove (Mobile) / Single Row (Desktop) */}
              <div className="flex items-center gap-3 sm:gap-5 flex-1">
                ...
                {/* Remove Button - Visible on mobile, hidden on desktop */}
                <button
                  onClick={() => onRemove(item.symbol)}
                  className="sm:hidden w-9 h-9 flex items-center justify-center rounded-xl text-black/40 dark:text-white/40 hover:bg-red-500/10 hover:text-red-500 transition-all hover:scale-105"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="flex items-center justify-center sm:justify-end gap-3">
                ...
                {/* Remove Button - Hidden on mobile, visible on desktop with hover */}
                <button
                  onClick={() => onRemove(item.symbol)}
                  className="hidden sm:flex w-9 h-9 items-center justify-center rounded-xl text-black/40 dark:text-white/40 hover:bg-red-500/10 hover:text-red-500 transition-all opacity-0 group-hover:opacity-100 hover:scale-105"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
