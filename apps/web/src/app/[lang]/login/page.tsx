        ...
        <div className="glass-panel p-8 md:p-10 backdrop-blur-xl border-white/40 dark:border-white/10 shadow-2xl animate-in fade-in zoom-in duration-500 slide-in-from-bottom-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <LocalizedLink href="/password-reset" className="text-xs font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 hover:underline transition-colors">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400">
              ...
              <LocalizedLink href="/signup" className="font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 hover:underline transition-colors">
